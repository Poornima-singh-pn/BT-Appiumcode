...
public class BottomNavigation extends Utilities {
	...
	public MobileElement exploreModule;
	
	//Search
	@AndroidFindBy(id="navigation_search")
	public MobileElement searchModule;
		
	//Message
	@AndroidFindBy(id="navigation_messages")
	public MobileElement messageModule;
				
	//Search
	@iOSFindBy(accessibility="tabbar account inactive")
	public MobileElement MYACCOUNT;
		
		public BottomNavigation(AppiumDriver<MobileElement> driver) throws InterruptedException {
	        this.driver = driver;
